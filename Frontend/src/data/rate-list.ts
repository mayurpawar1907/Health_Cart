/** Mirror of Backend/prisma/rate-list-data.ts — official HealthID Card rate list. */
...
export const POPULAR_TESTS = RATE_LIST.filter((t) =>
  [
    'Complete Blood Count (CBC) - 3 Part',
    'Thyroid Profile (T3, T4, TSH)',
    'Lipid Profile',
    'Glycated Hemoglobin (HbA1c) : HPLC',
    '25 Hydroxy Vitamin D3',
    'Liver Profile',
    'Kidney Profile (Urea, Creatinine, Uric Acid, BUN)',
    'Urine Routine',
  ].includes(t.name),
)
