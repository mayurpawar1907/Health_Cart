...
import { UserPage, UserPageHeader, UserPanel, UserTable, UserTd, UserTh, UserTHead, UserTr, } from '@/components/user/UserUi';
export function RemindersPage() {
    ...
    const q = useQuery({
        queryKey: ['reminders'],
        queryFn: async () => unwrap((await api.get('/reminders')).data),
    });
    ...
    return (<UserPage>
      ...
      {!q.data?.length ? (<EmptyState title="No reminders yet" body="Bookings automatically create reminders. You can add custom ones too."/>) : (<UserTable>
