...
import { UserBadge, UserEmptyRow, UserPage, UserPageHeader, UserPanel, UserStatCard, UserTable, UserTd, UserTh, UserTHead, UserTr, } from '@/components/user/UserUi';
...
export function WalletPage() {
    ...
    return (<UserPage>
      <UserPageHeader title="HealthID Wallet" subtitle="Use credits at checkout · Refer friends to earn more" actions={<div className="flex flex-wrap gap-2">
      ...
      <div>
        ...
        <UserTable>
          <table className="w-full min-w-[640px] text-left text-sm">
            ...
            <tbody>
              {w.transactions.length === 0 ? (<UserEmptyRow colSpan={4} message={`No wallet activity yet. Activate your card to receive ₹${w.rules.JOINING_BONUS} joining bonus.`}/>) : (w.transactions.map((t) => (<UserTr key={t.id}>
