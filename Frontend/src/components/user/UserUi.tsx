...
export function UserPage({ children, className }: { children: ReactNode; className?: string }) {
  return <div className={cn('mx-auto w-full max-w-6xl space-y-6', className)}>{children}</div>
}

export function UserPageHeader({ title, subtitle, actions }: { title: string; subtitle?: string; actions?: ReactNode }) {
  return (
...
export function UserPanel({ title, subtitle, children, className }: { title?: string; subtitle?: string; children: ReactNode; className?: string }) {
  return (
...
export function UserStatCard({ label, value, hint }: { label: string; value: string | number; hint?: string }) {
  return (
...
export function UserToolbar({ children }: { children: ReactNode }) {
    ...
    return (
      ...
      >
        ...
        <input
          ...
          className="min-w-0 flex-1 bg-transparent py-3 text-sm outline-none placeholder:text-ink-soft/60"
        />
  ...
  return (
    <div className="relative min-w-[200px] flex-1">
      ...
      <input
        ...
        placeholder={placeholder}
        className="w-full rounded-xl border border-line/80 bg-white/90 py-2.5 pl-10 pr-4 text-sm outline-none focus:border-teal focus:shadow-[0_0_0_4px_rgba(26,77,109,0.08)]"
      />
    </div>
  )
}

export function UserChip({ active, children, onClick }: { active: boolean; children: string; onClick: () => void }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className={cn(
        ...
        active ? 'bg-teal text-white shadow-sm' : 'border border-line/80 bg-white/80 text-ink-soft hover:border-teal/40 hover:text-teal',
      )}
    >
      {children}
    </button>
...
export function UserSection({ title, action, children }: { title: string; action?: ReactNode; children: ReactNode }) {
  return (
    <section>
...
export function UserQuickLink({ to, label }: { to: string; label: string }) {
  return (
    <Link
      to={to}
...
export function UserTable({ children }: { children: ReactNode }) {
  return (
...
export function UserTHead({ children }: { children: ReactNode }) {
  return (
    <thead>
...
export function UserTh({ children, className }: { children: ReactNode; className?: string }) {
  return <th className={cn('px-4 py-3.5 md:px-5', className)}>{children}</th>
}

export function UserTr({ children, className }: { children: ReactNode; className?: string }) {
  return <tr className={cn('border-b border-line/40 transition hover:bg-teal-light/30', className)}>{children}</tr>
}

export function UserTd({ children, className }: { children: ReactNode; className?: string }) {
...
export function UserEmptyRow({ colSpan, message }: { colSpan: number; message: string }) {
  return (
    <tr>
