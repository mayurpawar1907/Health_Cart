...
export function OfferCard({ test, badge, accentIndex = 0, fluid }: OfferCardProps) {
      ...
      <div className="flex flex-1 flex-col p-5">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap justify-end gap-1.5">
            ...
            {discountPct > 0 ? (
              <span className="inline-flex items-center gap-0.5 rounded-full bg-emerald-50 px-2.5 py-1 text-[10px] font-bold text-emerald-700">
        ...
        <div className="mt-auto border-t border-line/60 pt-4">
          ...
          <div className="mt-4 flex gap-2">
            <Link
              to={`/appointments/book?testId=${test.id}`}
