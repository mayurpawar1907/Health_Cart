...
export function HomeUpcoming({ testName, date, time, href }: HomeUpcomingProps) {
  return (
    <Link
      to={href}
      className="group flex items-center gap-4 rounded-2xl border border-teal/15 bg-white p-4 shadow-sm transition hover:border-teal/30 hover:shadow-md md:p-5"
    >
